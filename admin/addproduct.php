...
.btn:hover {
  ...
  <?php
   ...
   while($rows = mysqli_fetch_assoc($result))
    ...
    ?><a href="delete.php?id=<?=$rows['p_id'];?>" class=" btn"onclick="return confirm('Are you sure you want to Delete this record?');">Delete</a>
    <a href="update.php?id=<?=$rows['p_id'];?>" class=" btn">Update</a><?php
    }
   echo"</table>";
